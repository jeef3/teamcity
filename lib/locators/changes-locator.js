(function() {
  ...
  ChangeLocator = (function(_super) {
    ...
    ChangeLocator.dimensions(['id', 'project', 'buildType', 'build', 'vcsRoot', 'vcsRootInstance', 'username', 'user', 'version', 'internalVersion', 'comment', 'file', 'sinceChange', 'lookupLimit', 'start', 'count']);
